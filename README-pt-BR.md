...
O Livro Conciso de TypeScript fornece uma visão abrangente e sucinta das capacidades do TypeScript. Ele oferece explicações claras cobrindo todos os aspectos encontrados na versão mais recente da linguagem, desde seu poderoso sistema de tipos até recursos avançados. Seja você um iniciante ou um desenvolvedor experiente, este livro é um recurso inestimável para aprimorar sua compreensão e proficiência em TypeScript.

Este livro é completamente Gratuito e de Código Aberto.

Acredito que educação técnica de alta qualidade deve ser acessível a todos, e é por isso que mantenho este livro gratuito e aberto.

Se o livro te ajudou a resolver um bug, entender um conceito complicado ou avançar em sua carreira, por favor considere apoiar meu trabalho pagando o que quiser (preço sugerido: 15 USD) ou patrocinando um café. Seu apoio me ajuda a manter o conteúdo atualizado e expandi-lo com novos exemplos e explicações mais profundas.
...
- [O Livro Conciso de TypeScript](#o-livro-conciso-de-typescript)
  ...
  - [Explorando o Sistema de Tipos](#explorando-o-sistema-de-tipos)
    ...
    - [Estreitamento de Tipo](#estreitamento-de-tipo)
      - [Condições](#condições)
      - [Lançamento ou retorno](#lançamento-ou-retorno)
  ...
  - [Enums](#enums)
    ...
    - [Enums ambientes](#enums-ambientes)
  ...
  - [Estreitamento](#estreitamento)
    ...
    - [Estreitamento de veracidade](#estreitamento-de-veracidade)
    - [Estreitamento de igualdade](#estreitamento-de-igualdade)
    - [Estreitamento do operador In](#estreitamento-do-operador-in)
    - [Estreitamento instanceof](#estreitamento-instanceof)
  ...
  - [Tipo Tupla (Anônima)](#tipo-tupla-anônima)
  - [Tipo Tupla Nomeada (Rotulada)](#tipo-tupla-nomeada-rotulada)
  ...
  - [Tipo de Retorno de Função](#tipo-de-retorno-de-função)
  ...
  - [infer Inferência de Tipo in Conditional Types](#infer-type-inference-in-conditional-types)
  - [Tipos Condicionais Predefinidos](#tipos-condicionais-predefinidos)
  - [Tipos de União Template](#tipos-de-união-template)
  - [Tipo Any](#tipo-any)
  ...
  - [Class](#class)
    ...
    - [Decorators](#decorators)
      ...
      - [Decorator de Propriedade](#decorator-de-propriedade)
      - [Decorator de Método](#decorator-de-método)
      - [Decorators Getter e Setter](#decorators-getter-e-setter)
  ...
  - [Outros](#outros)
    ...
    - [Referência TsDocs JSDoc](#referência-tsdocs-jsdoc)
    - [@types](#types)
    - [JSX](#jsx-1)
    ...
    - [Tipos de Tupla Variádica](#tipos-de-tupla-variádica)
    - [Tipos boxed](#tipos-boxed)
    - [Covariância e Contravariância em TypeScript](#covariância-e-contravariância-em-typescript)
      - [Anotações de Variância Opcionais para Parâmetros de Tipo](#anotações-de-variância-opcionais-para-parâmetros-de-tipo)
    - [Assinaturas de Índice de Padrão de String Template](#assinaturas-de-índice-de-padrão-de-string-template)
...
Simone Poggiali é um engenheiro sênior experiente com paixão por escrever código de nível profissional desde os anos 90. Ao longo de sua carreira internacional, ele contribuiu para inúmeros projetos para uma ampla gama de clientes, desde startups até grandes organizações. Empresas notáveis como HelloFresh, Siemens, O2, Leroy Merlin and Snowplow se beneficiaram de sua experiência e dedicação.
...
Uma linguagem fortemente tipada permite ao desenvolvedor especificar várias restrições de programa e comportamentos na definição do tipo de dados, facilitando a capacidade de verificar a correção do software e prevenir defeitos. Isso é especialmente valioso em aplicações de grande escala.
...
* Suporte a ferramentas com IntelliSense
...
By leveraging these modern JavaScript features, developers can write more expressive and concise code em TypeScript.
...
Using the `const` keyword when declaring a variable results in a narrower type inference em TypeScript.
...
## infer Inferência de Tipo in Conditional Types
...
Both Iterators and Generators are well supported em TypeScript.
...
It is possible to conditionally load modules or lazy load them on-demand using the ECMAScript proposal for dynamic import which is supported em TypeScript.
...
It is possible to define complex type relationships using logic and recursion em TypeScript.
...
### Assinaturas de Índice de Padrão de String Template
