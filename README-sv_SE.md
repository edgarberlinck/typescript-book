...
- [Den koncisa TypeScript-boken](#den-koncisa-typescript-boken)
  ...
  - [Komma igång med TypeScript](#komma-igång-med-typescript)
    ...
    - [Råd för migrering till TypeScript](#råd-för-migrering-till-typescript)
  - [Utforska typsystemet](#utforska-typsystemet)
    - [TypeScript Language Service](#the-typescript-language-service)
    - [Strukturell typning](#strukturell-typning)
    - [TypeScripts grundläggande jämförelseregler](#typescripts-grundläggande-jämförelseregler)
    ...
    - [Egenskapskontroll och kontroll av överflödiga egenskaper](#egenskapskontroll-och-kontroll-av-överflödiga-egenskaper)
    - [Svaga typer](#svaga-typer)
    - [Strikt kontroll av objektlitteraler (Freshness)](#strikt-kontroll-av-objektlitteraler-freshness)
    ...
    - [Typförträngning](#typförträngning)
      - [Villkor](#villkor)
  ...
  - [Litteraltyper](#litteraltyper)
  - [Litteralinferens](#litteralinferens)
  ...
  - [Förträngning](#förträngning)
    ...
    - [Sanningsvärdesförträngning](#sanningsvärdesförträngning)
    - [Likhetsförträngning](#likhetsförträngning)
    - [In-operatorförträngning](#in-operatorförträngning)
    - [instanceof-förträngning](#instanceof-förträngning)
  ...
  - [Namngiven tupeltyp (Etiketterad)](#namngiven-tupeltyp-etiketterad)
  - [Tupel med fast längd](#tupel-med-fast-längd)
  - [Unionstyp](#unionstyp)
  - [Skärningstyper](#skärningstyper)
  - [Typindexering](#typindexering)
  - [Typ från värde](#typ-från-värde)
  - [Typ från funktionsretur](#typ-från-funktionsretur)
  ...
  - [Mallunionstyper](#mallunionstyper)
  - [Any-typen](#any-typen)
  - [Unknown-typen](#unknown-typen)
  - [Void-typen](#void-typen)
  - [Never-typen](#never-typen-1)
  - [Interface och Type](#interface-och-type)
    - [Vanlig syntax](#vanlig-syntax)
    - [Grundläggande typer](#grundläggande-typer)
    - [Objekt och gränssnitt](#objekt-och-gränssnitt)
    - [Unions- och skärningstyper](#unions--och-skärningstyper)
  - [Inbyggda typprimitiver](#inbyggda-typprimitiver)
  ...
  - [Klass](#klass)
    ...
    - [Dekoratorer](#dekoratorer)
      - [Klassdekoratorer](#klassdekoratorer)
      - [Egenskapsdekoratör](#egenskapsdekoratör)
      - [Metoddekoratör](#metoddekoratör)
      - [Getter- och setter-dekoratorer](#getter--och-setter-dekoratorer)
  ...
  - [Generics](#generics)
    ...
    - [Generisk kontextuell förträngning](#generisk-kontextuell-förträngning)
  - [Raderade strukturella typer](#raderade-strukturella-typer)
  - [Namnrymder](#namnrymder)
  - [Symboler](#symboler)
  - [Trippelsnedstrecksdirektiv](#trippelsnedstrecksdirektiv)
  - [Typmanipulering](#typmanipulering)
    - [Skapa typer från typer](#skapa-typer-från-typer)
    - [Indexerade åtkomsttyper](#indexerade-åtkomsttyper)
    - [Hjälptyper](#hjälptyper)
      - [Awaited\<T\>](#awaitedt)
      - [Partial\<T\>](#partialt)
  ...
  - [Övrigt](#övrigt)
    ...
    - [ES7 exponentiering-operator](#es7-exponentiering-operator)
    - [for-await-of-satsen](#for-await-of-satsen)
    - [New target meta-egenskap](#new-target-meta-egenskap)
    - [Dynamiska importuttryck](#dynamiska-importuttryck)
    - ["tsc –watch"](#tsc-watch)
    - [Non-null assertion-operatorn](#non-null-assertion-operatorn)
    - [Standarddeklarationer](#standarddeklarationer)
    - [Valfri kedja](#valfri-kedja)
    - [Nullish coalescing-operatorn](#nullish-coalescing-operatorn)
    - [Malllitteraltyper](#malllitteraltyper)
    - [Funktionsöverlagring](#funktionsöverlagring)
    - [Rekursiva typer](#rekursiva-typer)
    - [Rekursiva villkorliga typer](#rekursiva-villkorliga-typer)
    - [ECMAScript-modulstöd i Node](#ecmascript-modulstöd-i-node)
    - [Påståendefunktioner](#påståendefunktioner)
    - [Variadiska tupeltyper](#variadiska-tupeltyper)
    - [Inramade typer](#inramade-typer)
    - [Kovarians och kontravarians i TypeScript](#kovarians-och-kontravarians-i-typescript)
      - [Valfria variansannoteringar för typparametrar](#valfria-variansannoteringar-för-typparametrar)
    - [Mallsträngmönster-indexsignaturer](#mallsträngmönster-indexsignaturer)
